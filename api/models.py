...
class event(models.Model):
    eID = models.CharField(max_length=10,primary_key=True, unique=True)
    paid_status = models.CharField(max_length=10)
    ...
    pID = models.ForeignKey('event_package', models.DO_NOTHING, default="")
...
class tour(models.Model):
    ...
    t_description = models.CharField(max_length=200)
    date_time = models.DateTimeField(auto_now=True, auto_now_add=False)
    offID = models.ForeignKey('tour_offer',models.DO_NOTHING, null=True, default="")
    cID = models.ForeignKey('customer',models.DO_NOTHING, null=False, default="")
    packID = models.ForeignKey('tour_package',models.DO_NOTHING, null=False, default="")
...
class inquiry(models.Model):
    inquiryID = models.CharField(max_length=10,primary_key=True, unique=True)
...
class salary(models.Model):
    salaryID = models.CharField(max_length=10,primary_key=True, unique=True)
...
class attendance(models.Model):
    attendanceID = models.CharField(max_length=10,primary_key=True, unique=True)
...
class task(models.Model):
    taskID = models.CharField(max_length=10,primary_key=True, unique=True)
    empID = models.ForeignKey('employee',on_delete=models.CASCADE, null=False, default="")
