...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='event',
            fields=[
                ('eID', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
                ...
                ('cID', models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='api.customer')),
            ],
        ),
        migrations.CreateModel(
            name='event_offer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField()),
                ('income_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.income')),
                ('tID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.tour')),
            ],
        ),
        migrations.AddField(
            model_name='tour',
            name='offID',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.tour_offer'),
        ),
        migrations.AddField(
            model_name='tour',
            name='packID',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='api.tour_package'),
        ),
        migrations.CreateModel(
            name='task',
            fields=[
                ('taskID', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
                ('tack_description', models.CharField(max_length=400)),
                ('task', models.CharField(max_length=400)),
                ('empID', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.employee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplierID', models.ForeignKey(max_length=10, on_delete=django.db.models.deletion.CASCADE, to='api.supplier', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='salary',
            fields=[
                ('salaryID', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField()),
                ('income_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.income')),
                ('res_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.reservation')),
            ],
        ),
        migrations.AddField(
            model_name='reservation',
            name='ro_id',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='api.room_offer'),
        ),
        migrations.AddField(
            model_name='reservation',
            name='room_id',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='api.room'),
        ),
        migrations.CreateModel(
            name='order',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('itemID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.inventory')),
        ...
        migrations.CreateModel(
            name='inquiry',
            fields=[
                ('inquiryID', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time', models.DateTimeField(auto_now=True)),
                ('budgetID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.budget')),
                ('orderID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.order')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField()),
                ('eID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.event')),
                ('income_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.income')),
            ],
        ),
        migrations.AddField(
            model_name='event',
            name='oID',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.event_offer'),
        ),
        migrations.AddField(
            model_name='event',
            name='pID',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='api.event_package'),
        ),
        migrations.CreateModel(
            name='employee_phone',
            fields=[
        ...
        migrations.CreateModel(
            name='attendance',
            fields=[
                ('attendanceID', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
